...
@section('content')
    ...
    <form action="{{ route('updated-Warehouse.kepala', ['id' =>$warehouse->id]) }}" method="POST">
        @csrf
            ...
            <div class="row card-body">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama" class="form-control" placeholder="Enter Task Name" disabled
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select name="kepala" id="kepala" class="form-control" disabled >
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="lokasi" class="form-control" placeholder="Enter lokasi" disabled
